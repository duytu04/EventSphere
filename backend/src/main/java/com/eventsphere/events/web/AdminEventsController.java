...
//   public AdminEventsController(EventService s){ this.svc = s; }

//   @PostMapping
//   @ResponseStatus(HttpStatus.CREATED)
//   public EventResponse create(@Valid @RequestBody EventCreateRequest req){
//     var e = svc.create(req, null);
//     return map(e);
//   }
...
//   @PostMapping("/{id}/approve") public void approve(@PathVariable Long id){ svc.approve(id); }
//   @PostMapping("/{id}/reject")  public void reject(@PathVariable Long id){ svc.reject(id); }
...
//   // Trả về kiểu "PageResponse" đơn giản (nếu chưa có thì tạo nhanh bên dưới)
